    ...
    return (
      <div className="flex flex-row items-center gap-2">
        <Arrow
          ...
          color={
            COMPABILITY_COLOR[
              compatibilityScore.toString() as keyof typeof COMPABILITY_COLOR
            ]
          }
        />
        <div className="w-[20px]">
          {
            COMPABILITY_NOTATION[
              compatibilityScore.toString() as keyof typeof COMPABILITY_NOTATION
            ]
          }
        </div>
        <div>
