    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-bold text-primary">
          ...
          {t(
            '比較対象が持つ要素を確認',
            'Check the elements of each comparison target'
          )}
        </h2>
        <div>
          {t(
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-bold text-primary">
          ...
          {t(
            '要素同士の相性を示す矢印を確認',
            'Check the arrows showing compatibility between elements'
          )}
        </h2>
        <div>
          {t(
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-bold text-primary">
          ...
          {t(
            '各要素の相性スコアの平均点を確認',
            'Check the average compatibility score for each element'
          )}
        </h2>
        <div>
          {t(
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-bold text-primary">
          4. {t('相性の備考を確認', 'Check compatibility notes')}
        </h2>
        <div>
          {t(
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-xl font-bold text-primary">
          5. {t('要素の表示/非表示を切り替える', 'Toggle element visibility')}
        </h2>
        <div>
          {t(
