-- Fix copy_chart function to use correct table names and structure
...
BEGIN
  ...
  FOR element_record IN
    ...
    WHERE element_category_id = chart_data.left_category_id
  LOOP
  ...
  FOR element_record IN
    SELECT * FROM elements
    WHERE element_category_id = chart_data.right_category_id
  LOOP
    INSERT INTO elements (
      element_category_id,
      name
  ...
  LOOP
    ...
    BEGIN
      ...
      FROM elements
      WHERE element_category_id = left_category_id AND name = compatibility_record.left_element_name;
      
      SELECT id INTO new_right_element_id
      FROM elements
      WHERE element_category_id = right_category_id AND name = compatibility_record.right_element_name;
      ...
      INSERT INTO compatibilities (
        ...
        compatibility_record.compatibility_score_id,
        compatibility_record.reverse_compatibility_score_id,
