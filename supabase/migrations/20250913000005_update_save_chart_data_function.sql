-- Update save_chart_data function to include can_copy parameter
...
-- 関数の実行権限を付与
GRANT EXECUTE ON FUNCTION save_chart_data(UUID, TEXT, BOOLEAN, BOOLEAN, TEXT, TEXT, JSONB, JSONB, JSONB) TO authenticated;
